...
public class TrueTypeFont {
	...
	private void drawQuad(float drawX, float drawY, float drawX2, float drawY2,
        ...
        vb.pos(drawX, drawY, 0).tex(TextureSrcX, TextureSrcY).endVertex();

        //GL11.glTexCoord2f(TextureSrcX, TextureSrcY);
		//GL11.glVertex2f(drawX, drawY);
		
		//t.addVertexWithUV(drawX, drawY + DrawHeight, 0, TextureSrcX, TextureSrcY + RenderHeight);
        vb.pos(drawX, drawY + DrawHeight, 0).tex(TextureSrcX, TextureSrcY + RenderHeight).endVertex();

		//GL11.glTexCoord2f(TextureSrcX, TextureSrcY + RenderHeight);
		//GL11.glVertex2f(drawX, drawY + DrawHeight);
		
		//t.addVertexWithUV(drawX + DrawWidth, drawY + DrawHeight, 0, TextureSrcX + RenderWidth, TextureSrcY + RenderHeight);
        vb.pos(drawX + DrawWidth, drawY + DrawHeight, 0).tex(TextureSrcX + RenderWidth, TextureSrcY + RenderHeight).endVertex();

		//GL11.glTexCoord2f(TextureSrcX + RenderWidth, TextureSrcY + RenderHeight);
		//GL11.glVertex2f(drawX + DrawWidth, drawY + DrawHeight);
		
		//t.addVertexWithUV(drawX + DrawWidth, drawY, 0, TextureSrcX + RenderWidth, TextureSrcY);
        vb.pos(drawX + DrawWidth, drawY, 0).tex(TextureSrcX + RenderWidth, TextureSrcY).endVertex();
	...
	//	GL11.glBegin(GL11.GL_QUADS);
		if(rgba.length == 4)
		    vb.color(rgba[0], rgba[1], rgba[2], rgba[3]);
